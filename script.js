document.getElementById('mineralForm').addEventListener('submit', function(event) {
    ...
    const minerais = [
        { nome: 'Quartzo', brilho: 'não metálico', dureza: '7-10', cor: 'branco' },
        { nome: 'Açai', brilho: 'não metálico', dureza: '7-10', cor: 'branco' },
        { nome: 'Duca', brilho: 'não metálico', dureza: '7-10', cor: 'branco' },
        { nome: 'Quartzo', brilho: 'não metálico', dureza: '7-10', cor: 'branco' },
